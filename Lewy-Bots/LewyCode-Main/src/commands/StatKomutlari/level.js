...
run: async (client, message, args, prefix) => {
    if (!message.guild) return;
        ...
        const background = await loadImage("https://cdn.discordapp.com/attachments/938786568175513660/993950117621141534/lewyrank.png")
        ...
        loading.delete();
        const attachment = new MessageAttachment(image.toBuffer(), 'lewy.png');
